...
fn en(key: &'static str) -> &'static str {
    match key {
        ...
        "ed_summary_variants" => "Summary variants",
        "ed_summary_variants_hint" => "Extra summaries to pick from when tailoring a CV. `{{skills}}` in any summary is expanded to the job's top skills at Apply time.",
        "ed_summary_variant_placeholder" => "e.g. Leadership",
        "ed_add_summary_variant" => "+ Add variant",
        "ed_remove_summary_variant" => "Remove this variant",
        "ed_remove_summary_variant_last" => "Keep at least one variant",
        "ed_pick_template" => "… or pick a pre-written template",
        "tpl_concise"       => "Concise",
        "tpl_technical"     => "Technical",
        "tpl_leadership"    => "Leadership",
        // Experience
        ...
        "ed_all_experiences" => "← All experiences",
        "ed_n_projects"     => "{} projects",
        "ed_n_bullets"      => "{} bullets",
        // Skills
        "ed_skills_title"   => "Skills",
        "ed_skills_hint"    => "Add every skill — we'll surface the most relevant ones per job description.",
        "ed_skills_summary" => "Experience Summary",
        "ed_skills_summary_hint" => "Derived from your projects' time ranges — the same few years the printed CV shows. Use it to self-audit what you're claiming.",
        "ed_skills_no_data" => "No skill is linked to a project yet — add skills to your experiences and they'll show up here.",
        "ed_skills_untagged_n" => "{} skill(s) aren't linked to any project yet, so their bars stay empty.",
        ...
        "tl_saved_sessions" => "Saved sessions",
        "tl_save_as"        => "Save as…",
        "tl_save_as_placeholder" => "e.g. Acme — Platform Engineer",
        "tl_save"           => "Save",
        "tl_load"           => "Load",
        "tl_delete"         => "Delete",
        "tl_no_saved_sessions" => "No saved sessions yet.",
        "tl_adjust_selection" => "Adjust your selection",
        "tl_adjust_skills"    => "Adjust your skills",
        "tl_n_skills_selected" => "{} of {} skills selected",
        "tl_apply_selection"  => "Apply selection",
        "tl_nav_sections"     => "Sections",
        "tl_nav_summary"      => "Result",
        "tl_nav_adjust"       => "Adjust",
        "tl_nav_projects"     => "Projects",
        "tl_nav_skills"       => "Skills",
        "tl_nav_summaries"    => "Summary",
        "tl_nav_preview"      => "Preview",
        "tl_section_projects" => "Adjust projects",
        "tl_section_skills"   => "Adjust skills",
        "tl_section_summary"  => "Choose summary",
        "tl_section_summary_sub" => "Pick the professional summary for this job.",
        "tl_summary_default"  => "Default",
        "tl_use_default"      => "Use default",
        "tl_summary_edit_hint" => "Edit the text below — `{{skills}}` expands to the job's top skills at Apply time.",
        "tl_summary_skills" => "Skills used in {{skills}}",
        "tl_summary_skills_sub" => "Pick any skill from your CV — the job's best matches stay pre-checked.",
        "tl_summary_skills_reset" => "Reset to automatic",
        "tl_summary_skills_none" => "Your CV has no skills to list yet.",
        "tl_section_preview"  => "Open preview",
        "tl_section_preview_sub" => "See the tailored CV as it will print.",
        "tl_go_preview"       => "Go to preview",
        ...
        "tl_filter_all"       => "All",
        "tl_applied_on"       => "Applied on",
        "tl_status_applied"   => "Applied",
        "tl_status_interviewing" => "Interviewing",
        "tl_status_offer"     => "Offer received",
        ...
        "sy_session_expired" => "Google session expired — please sign in again.",
...
fn fr(key: &'static str) -> &'static str {
    match key {
        ...
        "ed_summary_variants" => "Variantes de résumé",
        "ed_summary_variants_hint" => "Résumés supplémentaires à choisir lors du tailoring. `{{skills}}` dans un résumé est remplacé par les compétences clés du poste à l'application.",
        "ed_summary_variant_placeholder" => "ex. Leadership",
        "ed_add_summary_variant" => "+ Ajouter une variante",
        "ed_remove_summary_variant" => "Supprimer cette variante",
        "ed_remove_summary_variant_last" => "Gardez au moins une variante",
        "ed_pick_template" => "… ou choisissez un modèle déjà rédigé",
        "tpl_concise"       => "Concis",
        "tpl_technical"     => "Technique",
        "tpl_leadership"    => "Leadership",
        // Experience
        ...
        "ed_all_experiences" => "← Toutes les expériences",
        "ed_n_projects"     => "{} projets",
        "ed_n_bullets"      => "{} lignes",
        // Experience projects
        "ed_projects"       => "Projets",
        ...
        "ed_skills_summary" => "Récapitulatif de l'expérience",
        "ed_skills_summary_hint" => "Calculé à partir des périodes de vos projets — les mêmes années que le CV imprimé. Servez-vous-en pour relire ce que vous affichez.",
        "ed_skills_no_data" => "Aucune compétence n'est reliée à un projet — ajoutez des compétences dans vos expériences pour les voir apparaître ici.",
        "ed_skills_untagged_n" => "{} compétence(s) ne sont reliées à aucun projet : leurs barres restent vides.",
        ...
        "tl_saved_sessions" => "Sessions enregistrées",
        "tl_save_as"        => "Enregistrer sous…",
        "tl_save_as_placeholder" => "ex. Acme — Platform Engineer",
        "tl_save"           => "Enregistrer",
        "tl_load"           => "Charger",
        "tl_delete"         => "Supprimer",
        "tl_no_saved_sessions" => "Aucune session enregistrée.",
        "tl_adjust_selection" => "Ajustez votre sélection",
        "tl_adjust_skills"    => "Ajustez vos compétences",
        "tl_n_skills_selected" => "{} sur {} compétences sélectionnées",
        "tl_apply_selection"  => "Appliquer la sélection",
        "tl_nav_sections"     => "Sections",
        "tl_nav_summary"      => "Résultat",
        "tl_nav_adjust"       => "Ajustement",
        "tl_nav_projects"     => "Projects",
        "tl_nav_skills"       => "Compétences",
        "tl_nav_summaries"    => "Résumé",
        "tl_nav_preview"      => "Aperçu",
        "tl_section_projects" => "Ajuster les projets",
        "tl_section_skills"   => "Ajuster les compétences",
        "tl_section_summary"  => "Choisir le résumé",
        "tl_section_summary_sub" => "Choisissez le résumé professionnel pour ce poste.",
        "tl_summary_default"  => "Par défaut",
        "tl_use_default"      => "Utiliser le défaut",
        "tl_summary_edit_hint" => "Modifiez le texte ci-dessous — `{{skills}}` est remplacé par les compétences clés du poste à l'application.",
        "tl_summary_skills" => "Compétences utilisées dans {{skills}}",
        "tl_summary_skills_sub" => "Choisissez n'importe quelle compétence de votre CV — les meilleures correspondances restent pré-cochées.",
        "tl_summary_skills_reset" => "Revenir à l'automatique",
        "tl_summary_skills_none" => "Votre CV ne contient encore aucune compétence à lister.",
        "tl_section_preview"  => "Ouvrir l'aperçu",
        "tl_section_preview_sub" => "Le CV adapté tel qu'il s'imprimera.",
        "tl_go_preview"       => "Voir l'aperçu",
        ...
        "tl_filter_all"       => "Tous",
        "tl_applied_on"       => "Postulée le",
        "tl_status_applied"   => "Postulée",
        "tl_status_interviewing" => "Entretien",
        "tl_status_offer"     => "Offre reçue",
        "tl_status_rejected"  => "Refusée",
        ...
        "sy_session_expired" => "Session Google expirée — veuillez vous reconnecter.",
