...
fn en(key: &'static str) -> &'static str {
    match key {
        ...
        "tl_summary_skills_sub" => "Automatic picks are the job's best-rated skills. Tick/untick to override.",
        "tl_summary_skills_reset" => "Reset to automatic",
        "tl_generate_first" => "Run the match first — automatic skills appear once a result exists.",
...
fn fr(key: &'static str) -> &'static str {
    match key {
        ...
        "tl_summary_skills_sub" => "Les choix automatiques sont les compétences les mieux notées pour le poste. Cochez/décochez pour personnaliser.",
        "tl_summary_skills_reset" => "Revenir à l'automatique",
        "tl_generate_first" => "Lancez d'abord l'analyse — les compétences automatiques apparaissent une fois le résultat généré.",
