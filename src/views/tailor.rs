...
///    Apply/Reset/Clear row (skills only).
                        ...
                        div { class: "tailor-output",
                            ...
                            if *view.read() == TailorView::Summary {
                                ...
                                div { class: "item-list",
                                    ...
                                    div { class: "item-card",
                                        div { class: "item-card-body clickable",
                                            onclick: move |_| view.set(TailorView::Skills),
                            ...
                            if *view.read() == TailorView::Projects {
                                div { class: "drill",
                                    div { class: "breadcrumb",
                                        button { class: "btn-text breadcrumb-crumb",
                                            onclick: move |_| view.set(TailorView::Summary),
                                        ...
                                        span { class: "breadcrumb-sep", "›" }
                                        span { class: "breadcrumb-current", "{t_nav_projects}" }
                                    }
                            ...
                            if *view.read() == TailorView::Skills {
                                div { class: "drill",
                                    div { class: "breadcrumb",
                                        button { class: "btn-text breadcrumb-crumb",
                                            onclick: move |_| view.set(TailorView::Summary),
                                        ...
                                        span { class: "breadcrumb-sep", "›" }
                                        span { class: "breadcrumb-current", "{t_nav_skills}" }
                                    }
